			...
			<input type="hidden" name="token" value="{{ $token }}">
                    ...
                    <div class="flex justify-center  text-white p-2 ">
                        <div class="flex justify-start items-center  w-10/12 py-2 px-4 border-2 border-white rounded-md @error('password') is-invalid border-3 border-red-700 @enderror">
                            ...
                            <div class="text-xl">
                                <input type="password" name="password" class="bg-blue-700 ml-5 focus:outline-none border-0 placeholder-white text-center w-40" placeholder="password" required autocomplete="new-password">
                            </div>
                        </div>
                    </div>
                    <div class="mx-10">
                    ...
                    <div class="flex justify-center  text-white p-2 ">
                        <div class="flex justify-start items-center  w-10/12 py-2 px-4 border-2 border-white rounded-md @error('password') is-invalid border-3 border-red-700 @enderror">
                            <i class="far fa-lock text-2xl mr-4"></i>
                            <div class="text-xl">
                                <input type="password" name="password_confirmation" class="bg-blue-700 ml-5 focus:outline-none border-0 placeholder-white text-center w-40" placeholder="confirm password" required autocomplete="new-password">
                            </div>
                        </div>
                    </div>
                    <div class="mx-10">
                    ...
                    <div class="flex justify-center mb-2 ">
                        <button type="submit" class="bg-white text-blue-800 shadow-xl border border-gray-800 text-xl rounded-md w-full py-2 font-bold mx-10">Reset Password</button>
                    </div>
