...
>>>>>>> 3c251c5e9989371c5a2a89a95c04d87e87c2e65b
                ...
                <div class="mt-4 mx-8 flex justify-center">
                    <input type="text" name="remarks" id="title" placeholder="Item Details" class="px-2 py-2 border border-blue-400 placeholder-gray-600 font-bold pl-5  rounded w-8/12">
                </div>
            </div>
            <div class="mx-5">
                <div class="">
