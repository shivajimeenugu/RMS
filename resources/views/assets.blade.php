        ...
        <div class="lg:w-4/12 w-full h-screen bag">
            <div class="pb-4">
                ...
                <div class="mx-10 mt-5 flex justify-start">
                    <a href="{{route('assets')}}" class="border-2 mr-4 border-blue-800 text-white font-bold text-xl rounded-md px-4 py-1 bg-blue-600">Assets</a>
                    <a href="{{route('liabalities')}}" class="border-2  border-blue-800 text-purple-900 font-bold text-xl rounded-md px-4 py-1 bg-white ">Liabalities</a>
